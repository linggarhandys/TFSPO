...
const PraktikumP1p3percobaan = () => {
  ...
  const steps = [
    {
      label: (
        <Typography>
          Putar Input potentiometer menuju sudut 150 dan click enter
        </Typography>
      ),
      description: (
    ...
    {
      label: <Typography>Catat hasil pada lembar kerja</Typography>,
      description: (
        <Box>
    ...
    },
    {
      label: (
        <Typography>
          Lakukan langkah 1 dan 2 dengan sudut 200, 250, 300, dan 350
        </Typography>
      ),
      description: "",
    },
    {
      label: <Typography>Download data lembar kerja</Typography>,
      description: "",
    },
  ];
  ...
  const url =
    "https://api.thingspeak.com/update?api_key=KRBZ5PPPBY4F46WF&field2=0&field3=0&field4=0&field5=0&field6=0&field1=";
...
export default PraktikumP1p3percobaan;
